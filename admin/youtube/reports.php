...
curl_setopt($ch, CURLOPT_URL, 
  'https://accounts.google.com/ServiceLogin?hl=en&');//service=youtube&continue=https://www.youtube.com/dashboard');
...
foreach ($rows as $row) {
    ...
    $con->query("INSERT INTO videos (id,title,channel,views,earnings,year,trimester,thumbnail) VALUES ('{$video['id']}','{$video['title']}','{$video['channel']}','{$video['views']}','{$video['earnings']}','{$_GET['year']}','{$_GET['trimester']}','{$thumbBase64}')");
